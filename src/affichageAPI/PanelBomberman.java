...
public class PanelBomberman extends JPanel implements KeyListener,Serializable {
	...
	public PanelBomberman(Map map, Client c) {
	...
	private static AgentAction last;
	...
	public void keyPressed(KeyEvent arg0) {
		switch (arg0.getExtendedKeyCode()) {
			case KeyEvent.VK_RIGHT:
				client.setRequete(AgentAction.MOVE_RIGHT.getDeplacement());
				client.envoyerRequete();
				break;
			case KeyEvent.VK_UP:
				client.setRequete(AgentAction.MOVE_UP.getDeplacement());
				client.envoyerRequete();
				break;
			case KeyEvent.VK_DOWN:
				client.setRequete(AgentAction.MOVE_DOWN.getDeplacement());
				client.envoyerRequete();
				break;
			case KeyEvent.VK_LEFT:
				client.setRequete(AgentAction.MOVE_LEFT.getDeplacement());
				client.envoyerRequete();
				break;
			default:
				break;
	...
	public void keyTyped(KeyEvent e) {
		...
		if (e.getKeyChar() == 'A' || e.getKeyChar() == 'a') {
			client.setRequete(AgentAction.PUT_BOMB.getDeplacement());
			client.envoyerRequete();
